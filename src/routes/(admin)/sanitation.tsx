...
export const Route = createFileRoute("/(admin)/sanitation")({
  head: () => ({
    meta: [
      { title: "Sanitation Levy & Environmental Compliance — Kwali" },
      {
        name: "description",
        content:
          "Monthly refuse collection, commercial waste permits and environmental compliance certificates for Kwali residents and businesses.",
      },
    ],
  }),
...
const benefits = [
  {
    i: "🚛",
    t: "Scheduled refuse collection",
    d: "Door-to-door pickup twice a week in your ward.",
  },
  {
    i: "♻️",
    t: "Recycling drop-off points",
    d: "Plastics, glass and metals diverted from landfill.",
  },
...
function SanitationPage() {
  return (
    <SiteShell>
      <PageHeader
        eyebrow="Environment"
        title="Sanitation levy & compliance"
        subtitle="Pay your monthly sanitation fee and obtain commercial waste and environmental compliance permits."
      />
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-border bg-card p-6 text-center shadow-[var(--shadow-card)]">
            ...
            <div className="mt-2 font-display text-4xl font-bold text-primary">
              ₦500<span className="text-sm text-muted-foreground">/mo</span>
            </div>
            <p className="mt-3 text-sm text-muted-foreground">
              Per household, includes door-to-door refuse collection.
            </p>
          </div>
          <div className="rounded-2xl border-2 border-primary bg-card p-6 text-center shadow-[var(--shadow-elegant)]">
            ...
            <div className="mt-2 font-display text-4xl font-bold text-primary">
              ₦2,000<span className="text-sm text-muted-foreground">/mo</span>
            </div>
            <p className="mt-3 text-sm text-muted-foreground">
              Shops, kiosks and small businesses under 50sqm.
            </p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-6 text-center shadow-[var(--shadow-card)]">
            <div className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">
            ...
            <div className="mt-2 font-display text-4xl font-bold text-primary">
              ₦8,000<span className="text-sm text-muted-foreground">/mo</span>
            </div>
            <p className="mt-3 text-sm text-muted-foreground">
              Hotels, factories and large commercial premises.
            </p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-3">
              {penalties.map((p) => (
                <div
                  key={p.t}
                  className="rounded-xl border-l-4 border-destructive bg-destructive/5 p-4"
                >
