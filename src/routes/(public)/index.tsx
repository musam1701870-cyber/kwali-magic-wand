...
import heroImg from "@/shared/assets/kwali-hero.jpg";
...
function Hero() {
  ...
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      />
      <div
        className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(201,168,76,0.18),transparent_60%)]"
        aria-hidden
      />
        ...
        <div className="relative">
          ...
          <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-white/20 shadow-2xl">
            ...
            <div className="absolute bottom-16 left-5 right-5 text-white">
              ...
              <div className="mt-1 text-xs text-white/80">
                Register, get billed, pay — all in one place.
              </div>
            </div>
          ...
          <div className="absolute -bottom-10 -left-4 hidden w-[280px] rounded-2xl border border-border bg-card p-4 shadow-[var(--shadow-elegant)] sm:block md:-left-10">
            ...
            <div className="mt-2 grid grid-cols-2 gap-2">
              <Link
                to="/auth/signup"
                className="rounded-md bg-primary py-1.5 text-center text-[11px] font-bold text-primary-foreground hover:opacity-95"
              >
                Generate Bill
              </Link>
              <Link
                to="/auth/login"
                className="rounded-md bg-gold py-1.5 text-center text-[11px] font-bold text-gold-foreground hover:opacity-95"
              >
                Pay Now
              </Link>
            </div>
    ...
    <section className="relative overflow-hidden border-y border-border bg-card">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-2 divide-x divide-border sm:grid-cols-4">
        {stats.map((s, i) => (
          <div
            key={s.l}
            className={`relative flex flex-col items-center px-6 py-10 text-center ${i > 0 ? "" : ""}`}
          >
...
const steps = [
  {
    n: "01",
    t: "Register",
    d: "Create an account with your phone, NIN or CAC number. Add your property, business or vehicle.",
  },
  {
    n: "02",
    t: "Get your bill",
    d: "We auto-assess your tenement, business, sanitation or transport rate and generate an RRR reference.",
  },
  {
    n: "03",
    t: "Pay online",
  ...
  },
  {
    n: "04",
    t: "Get receipt",
    d: "Download your e-receipt with QR code. Enforcement officers verify it offline.",
  },
];
...
const features = [
  {
    ...
    img: imgBusiness,
    t: "Shops & Offices",
    d: "Yearly business permit for shops, offices and SMEs across Kwali.",
  },
  {
    id: "property",
    img: imgProperty,
    t: "Houses & Land",
    d: "Annual tenement rates and ground rent for residential or commercial property.",
  },
  {
    id: "market",
    img: imgMarket,
    t: "Market Stalls",
    d: "Daily market tickets, stall allocation and lockup shop fees.",
  },
  {
    id: "transport",
    img: imgTransport,
    t: "Keke, Okada & Buses",
    d: "₦100 daily ticket plus QR sticker for tricycles, bikes and buses.",
  },
  {
    id: "hospitality",
    img: imgHotel,
    t: "Hotels & Event Centres",
    d: "Operating permits for hotels, lodges, lounges and event halls.",
  },
  {
    id: "sanitation",
    img: imgSanitation,
    t: "Waste & Sanitation",
    d: "Monthly refuse pickup enrolment and environmental compliance fees.",
  },
  {
    id: "pos",
    img: imgPos,
    t: "POS & Mobile Money",
    d: "Annual operator permit for POS agents and mobile-money kiosks.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-4xl font-bold text-ink">Every council levy in one portal</h2>
            <p className="mt-3 text-sm text-muted-foreground">
              Choose a category to register or pay — plain-English descriptions so you know exactly
          ...
          {features.map((f) => (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3 px-5 py-4">
                ...
                <span className="shrink-0 text-sm font-semibold text-primary opacity-0 transition group-hover:opacity-100">
                  →
                </span>
              </div>
            </Link>
...
const services = [
  {
    id: "property",
    t: "Tenement Rate",
    d: "Annual property rate for residential and commercial buildings.",
    price: "From ₦5,000/yr",
  },
  {
    id: "business",
    t: "Business Premises",
    d: "Annual permit for shops, offices and SMEs operating in Kwali.",
    price: "From ₦10,000/yr",
  },
  {
    id: "sanitation",
    t: "Sanitation Levy",
    d: "Monthly refuse collection and environmental compliance.",
    price: "From ₦500/mo",
  },
  {
    id: "transport",
    t: "Tricycle Daily Ticket",
    d: "Daily route permit with QR-coded windshield sticker.",
    price: "₦100/day",
  },
  {
    id: "transport",
    t: "Motorbike Permit",
    d: "Annual okada registration plus daily compliance ticket.",
    price: "₦100/day",
  },
  {
    id: "transport",
    t: "Commercial Vehicle",
    d: "Loading bay and route permits for buses and trucks.",
    price: "Tiered",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            All levies and permits handled through one secure portal.
          </p>
        </div>
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            <div
              key={s.t}
              className="group flex flex-col rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)] transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-[var(--shadow-elegant)]"
            >
              <h3 className="text-lg font-bold text-ink">{s.t}</h3>
              ...
              <div className="mt-6 flex items-center justify-between border-t border-border pt-4">
                ...
                <Link
                  to={`/auth/signup?category=${s.id}`}
                  className="flex items-center gap-1 text-sm font-semibold text-primary opacity-0 transition group-hover:opacity-100 hover:underline"
                >
            ...
            <div className="mx-auto grid h-32 w-32 place-items-center rounded-xl bg-ink text-gold">
              <svg viewBox="0 0 100 100" className="h-24 w-24" aria-hidden>
                ...
                {Array.from({ length: 81 }).map((_, i) => {
                  ...
                  const fill = (i * 37) % 5 < 2;
                  return fill ? (
                    <rect key={i} x={x} y={y} width="10" height="10" fill="currentColor" />
                  ) : null;
                })}
              </svg>
            </div>
...
const faqs = [
  [
    "Who needs to pay tenement rate?",
    "Every property owner in Kwali — residential or commercial — is required to pay an annual tenement rate based on the property's assessed value.",
  ],
  [
    "How does the daily transport ticket work?",
    "Operators pay ₦100/day per tricycle or motorbike. A QR-coded sticker is issued and verified by enforcement officers on patrol.",
  ],
  [
  ...
  [
    ...
    "Yes. Anyone can verify a receipt by scanning its QR code or entering the reference number on our Verify page.",
  ],
];
          ...
          {faqs.map(([q, a]) => (
            ...
            >
              <summary className="flex cursor-pointer list-none items-center justify-between text-base font-semibold text-ink [&::-webkit-details-marker]:hidden">
                {q}
                <span className="ml-4 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-border bg-secondary text-sm font-bold text-muted-foreground transition group-open:rotate-45 group-open:border-primary/30 group-open:bg-primary/8 group-open:text-primary">
                  +
                </span>
              </summary>
...
const accountTypes = [
  {
    id: "property",
    icon: "🏠",
    title: "Resident / Property Owner",
    desc: "Register your home or land, get a tenement assessment and pay annual rates plus monthly sanitation levy.",
    perks: [
      "Tenement rate billing",
      "Sanitation pickup enrolment",
      "Multiple properties on one dashboard",
    ],
  },
  {
    id: "business",
    ...
    desc: "Register your shop, office or SME with CAC details and pay your annual business premises permit.",
    perks: ["Business premises permit", "Signage & advert levies", "Compliance certificate"],
  },
  {
    id: "transport",
    icon: "🛵",
    title: "Transport Operator",
    desc: "Onboard your tricycle, motorbike or commercial vehicle and pay daily route permits in seconds.",
    perks: ["Daily ₦100 ticket", "QR sticker for windshield", "Offline verifiable receipts"],
  },
];
    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Pick the role that fits — you can add more profiles later from your dashboard.
          </p>
        </div>
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {accountTypes.map((a) => (
            <div
              key={a.title}
              className="flex flex-col rounded-2xl border border-border bg-card p-7 shadow-[var(--shadow-card)] transition hover:-translate-y-1 hover:border-primary/40 hover:shadow-[var(--shadow-elegant)]"
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-secondary text-3xl shadow-sm">
                {a.icon}
              </div>
              ...
              <Link
                to={`/auth/signup?category=${a.id}`}
                className="mt-6 inline-flex w-fit items-center gap-1 rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-sm transition hover:-translate-y-0.5 hover:opacity-95"
              >
...
const testimonials = [
  {
    initials: "MA",
    name: "Mallam Abubakar",
    role: "Landlord, Kwali Town",
    body: "I used to travel to the council secretariat just to pay my tenement rate. Now I do it from my phone in minutes and the receipt downloads instantly.",
  },
  {
    initials: "BO",
    name: "Blessing Ogaji",
    role: "Shop owner, Yangoji",
    body: "Renewing my business premises permit on KURCMS took less than five minutes. The compliance certificate is accepted on the spot during inspections.",
  },
  {
    initials: "SI",
    name: "Sani Idris",
    role: "Tricycle operator, Kilankwa",
    body: "₦100 a day, paid by USSD, QR sticker on the windshield — no more arguments with task force officers. The scanner shows I'm compliant.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 text-4xl font-bold text-ink">
            Trusted by Kwali property, business & transport owners
          </h2>
        </div>
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {testimonials.map((t) => (
