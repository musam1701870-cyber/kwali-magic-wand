...
const content: Record<Category, EducationContent> = {
  property: {
    ...
    faqs: [
      {
        q: "Is Tenement Rate the same as Ground Rent?",
        a: "No. Ground Rent is paid to the federal government (AGIS/FCDA) for the lease of the land itself. Tenement Rate is a separate municipal tax paid to Kwali Area Council for the developed, occupied structure. Both can apply simultaneously.",
      },
      {
        q: "Can I challenge my assessment?",
        a: "Yes. File a formal Notice of Objection with the Head of the Valuation Unit at the Kwali Area Council Secretariat. Note: you must deposit 50% of the disputed rate upfront before your objection can be formally heard.",
      },
      {
        q: "How do I verify a legitimate collector?",
        a: "Never pay cash to any field agent. All payments must be made via bank transfer or KURCMS. Always demand an official automated receipt bearing the council stamp and treasury signature.",
      },
    ],
  },
  ...
  business: {
    ...
    faqs: [
      {
        q: "Do I still need this if I already registered with CAC?",
        a: "Yes. CAC registration is federal and only establishes your business as a legal entity. The Business Premises Permit is a local government levy for operating within Kwali's jurisdiction. Both are required.",
      },
      {
        q: "What if I operate from home?",
        a: "Home-based businesses that receive clients or store commercial inventory are still subject to a reduced Home Office Levy. Purely online businesses with no physical footprint may apply for an exemption review.",
      },
      {
        q: "What is included in the permit fee?",
        a: "Your permit fee contributes to road maintenance within the market/commercial zones, waste collection from business premises, council enforcement and inspection, and fire and environmental safety oversight.",
      },
    ],
  },
  ...
  market: {
    ...
    tagline:
      "Market daily tickets and trader permits are backed by the Kwali Market Regulation Bye-Law",
    ...
    rateSummary:
      "Category C ₦100/day · Category B ₦200/day · Category A ₦300/day · Monthly Pass ₦2,000",
    rateDetail:
    ...
    faqs: [
      {
        q: "Why do I need a Trader ID if I move around the market?",
        a: "The Kwali system tracks the person, not the location. Your QR-coded Trader ID (KWL-TRD-XXXXXX) stays with you regardless of where you trade within the market. Officers scan your card — you don't need a fixed stall.",
      },
      {
        q: "What happens to my daily market fee?",
        a: "Market levies fund: daily market cleaning and waste disposal, security and enforcement patrols, infrastructure repairs, and the digital payment system itself. A portion also funds the Market Association welfare programme.",
      },
      {
        q: "Can I pay with my phone?",
        a: "Yes. Pay via USSD, bank transfer, or the KURCMS app. Once paid, your Trader ID status instantly updates to 'PAID TODAY' — visible to any scanning officer.",
      },
    ],
  },
  ...
  transport: {
    ...
    tagline:
      "The Transport Levy is a mandatory daily route permit under the Kwali Motorcycle Uses Bye-Law",
    ...
    rateSummary:
      "Tricycle/Motorbike ₦100/day · Commercial Vehicle tiered · Annual permit available",
    rateDetail:
    ...
    faqs: [
      {
        q: "Can I pay the daily ₦100 via USSD?",
        a: "Yes. Dial the KURCMS USSD code, select 'Transport', enter your plate number and pay. Your compliance status updates instantly on the enforcement database.",
      },
      {
        q: "What if an officer claims my paid sticker is invalid?",
        a: "Demand that the officer scan the QR code on your windshield sticker. The system will display your payment record including receipt number, date/time, and officer who issued it. Any discrepancy can be reported via the KURCMS helpline.",
      },
      {
        q: "Do I need both an annual permit and daily tickets?",
        a: "The annual permit covers your vehicle registration in the system. Daily tickets cover your specific operating days. Both are required for full compliance.",
      },
    ],
  },
};
...
function FAQItem({ faq }: { faq: FAQ }) {
  ...
  return (
    <div className="rounded-xl border border-border bg-background">
      ...
      {open && (
        <p className="border-t border-border px-4 pb-3 pt-2 text-sm leading-relaxed text-muted-foreground">
          {faq.a}
        </p>
      )}
    </div>
      ...
      {expanded && (
        <div className="border-t border-primary/15 px-5 pb-5 pt-4 space-y-5">
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
            <div className="mb-1 text-xs font-bold uppercase tracking-widest text-amber-700">
