...
import { feeCategories } from "@/shared/lib/kwali-mock";
  ...
  head: () => ({
    meta: [
      { title: "Services & Fee Categories — Kwali Revenue Portal" },
      {
        name: "description",
        content:
          "All Kwali Area Council fee categories — tenement, business, sanitation, transport, advertisement, environmental.",
      },
    ],
  }),
...
function ServicesPage() {
  return (
    <SiteShell>
      <PageHeader
        eyebrow="Services"
        title="All council fee categories"
        subtitle="Pick the levy that applies to you. Each category links to a payment flow with auto-assessment."
      />
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {feeCategories.map((s) => (
            ...
            >
              ...
              <Link
                to="/dashboard"
                className="mt-5 inline-flex w-fit items-center rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:opacity-95"
              >
                Pay this fee →
              </Link>
            </div>
