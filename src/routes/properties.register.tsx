...
function RegisterPropertyPage() {
  return (
    <DashboardShell title="Register a property" subtitle="Tag it with GPS so assessment is accurate.">
      <form onSubmit={(e) => { e.preventDefault(); window.location.assign("/properties"); }} className="mx-auto max-w-3xl space-y-6 rounded-2xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
